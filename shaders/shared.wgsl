...
var<private> AMINO_DATA: array<array<vec4<f32>, 6>, AMINO_COUNT> = array<array<vec4<f32>, 6>, AMINO_COUNT>(
    ...
    // 3  E - Glutamic acid
    array<vec4<f32>,6>( vec4<f32>(13.0, 3.0, -0.12, 0.02), vec4<f32>(0.1, 0.12, 0.0, 0.001), vec4<f32>(0.3, 0.4, 0.1, 0.0), vec4<f32>(0.0, 0.3, -0.58, -0.058), vec4<f32>(0.2, 0.6, 0.4, 0.55), vec4<f32>(0.45, 0.0, 0.0, 0.0) ),
    // 4  F - Phenylalanine
